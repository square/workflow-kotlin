 ...
 *
 * This can be extremely useful for establishing a "trail of breadcrumbs" for what your application
 * has done.
 */
public fun interface WorkflowRuntimeLoopListener {
   ...
   * that loop.
   */
  public fun onRuntimeLoopSettled(configSnapshot: ConfigSnapshot, runtimeUpdates: RuntimeUpdates)
}

/**
 * Simple wrapper object for a list of [RuntimeUpdateLogLine]s. This allows us to add updates and
 * provides a [readAndClear] API to clear the list after it is read.
 */
...
internal constructor(
  ...
  public fun readAndClear(): List<RuntimeUpdateLogLine> =
    updateLines.toList().also { updateLines.clear() }
}
