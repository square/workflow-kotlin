...
/**
 * A Worker that adds in a key to its [toString] that [ActionHandlingTracingInterceptor] knows how
 * to read when observing action handling.
 */
@OptIn(FlowPreview::class)
class TraceableWorker<OutputT>(private val name: String, private val work: Flow<OutputT>) :
  Worker<OutputT> {
