 ...
 * @param keyStrokes A [Worker] that emits a [KeyStroke] every time the user hits a keyboard key. If
 *   a child workflow needs access to key events, you can just pass this worker down directly, or
 ...
 */
data class TerminalProps(val size: TerminalSize, val keyStrokes: Worker<KeyStroke>)
