...
/**
 * "Saves" game state, to demonstrate using services from a workflow. Actually just reports success
 * or failure, usually the latter.
 */
interface GameLog {
...
class RealGameLog(private val mainThread: Scheduler) : GameLog {
