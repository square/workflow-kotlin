...
internal class GameOverLayoutRunner(private val binding: GamePlayLayoutBinding) :
  ScreenViewRunner<GameOverScreen> {

  private val saveItem: MenuItem =
    binding.gamePlayToolbar.menu.add("").apply { setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS) }

  private val exitItem: MenuItem =
    binding.gamePlayToolbar.menu.add("Exit").apply {
      setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM)
    }

  override fun showRendering(rendering: GameOverScreen, environment: ViewEnvironment) {
  ...
  private fun renderResult(toolbar: Toolbar, completedGame: CompletedGame, playerInfo: PlayerInfo) {
  ...
  companion object :
    ScreenViewFactory<GameOverScreen> by fromViewBinding(
