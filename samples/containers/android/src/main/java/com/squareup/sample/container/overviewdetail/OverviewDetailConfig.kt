...
/**
 * [com.squareup.workflow1.ui.ViewEnvironment] value that informs views whether they're children of
 * a [OverviewDetailContainer], and if so in what configuration.
 */
