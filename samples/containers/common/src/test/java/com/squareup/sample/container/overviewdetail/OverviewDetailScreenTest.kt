...
internal class OverviewDetailScreenTest {
  ...
  fun `minimal hash`() {
    ...
    assertThat(screen.hashCode())
      .isEqualTo(OverviewDetailScreen(BackStackScreen(FooScreen(1))).hashCode())
    assertThat(screen.hashCode())
      ...
      .isEqualTo(
        OverviewDetailScreen(
          overviewRendering =
            BackStackScreen(FooScreen(1), FooScreen(2), FooScreen(11), FooScreen(12)),
          detailRendering =
            BackStackScreen(FooScreen(3), FooScreen(4), FooScreen(13), FooScreen(14)),
        )
      )
  }

  @Test
  fun `selectDefault structure`() {
    val selectDefault = {}
    val screen =
      OverviewDetailScreen(
        overviewRendering = BackStackScreen(FooScreen(1), FooScreen(2)),
  ...
  @Test
  fun `can combine heterogenous content`() {
    val left =
      OverviewDetailScreen(
        overviewRendering = BackStackScreen(FooScreen(1), FooScreen(2)),
    ...
    assertThat(left + right)
      .isEqualTo(
        OverviewDetailScreen(
          overviewRendering =
            BackStackScreen(FooScreen(1), FooScreen(2), BarScreen(11), BarScreen(12)),
          detailRendering =
            BackStackScreen(BarScreen(3), BarScreen(4), FooScreen(13), FooScreen(14)),
        )
      )
  }
}
