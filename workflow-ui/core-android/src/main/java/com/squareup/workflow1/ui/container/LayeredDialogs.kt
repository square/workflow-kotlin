...
public class LayeredDialogs private constructor(
  ...
  public companion object {
     ...
     * serve as the source for a [LifecycleOwner], will be monitored to drive calls
     * to [onAttachedToWindow] and [onDetachedFromWindow],
     * and whose bounds will be reported via [OverlayArea].
     *
     ...
     *
     * - The [view]'s [onAttachedToWindow][View.onAttachedToWindow]
     *
     * - Its [onSaveInstanceState][View.onSaveInstanceState] and
     *   [onRestoreInstanceState][View.onRestoreInstanceState] methods should use
     *   the like named [LayeredDialogs] methods.
     */
    public fun forView(
      view: View,
