...
/**
 * Returns the [WorkflowLayout] serving as the [contentView][Activity.setContentView] of the
 * receiving [Activity], creating it (and replacing the existing view) if necessary.
 */
val Activity.workflowContentView: WorkflowLayout
  get() {
    return workflowContentViewOrNull
      ?: WorkflowLayout(this).also {
...
/**
 * Returns the [WorkflowLayout] serving as the [contentView][Activity.setContentView] of the
 * receiving [Activity], or null if there isn't one.
 */
