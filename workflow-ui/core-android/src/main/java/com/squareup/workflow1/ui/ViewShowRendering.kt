...
/**
 * Returns the most recent [Screen] rendering [shown][ScreenViewHolder.show] in this view, or throws
 * a [NullPointerException] if the receiver was not created via [ScreenViewFactory.startShowing].
 */
...
/**
 * Returns the most recent [Screen] rendering [shown][ScreenViewHolder.show] in this view, or `null`
...
/**
 * Returns the most recent [ViewEnvironment] applied to this view, or null if the receiver was not
 * initialized via [ScreenViewHolder.startShowing].
 */
