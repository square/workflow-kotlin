...
/**
 * Used by [ViewStateCache] to record the [viewState] data for the view identified by [key], which
 * is expected to match the `toString()` of a
 * [com.squareup.workflow1.ui.Compatible.compatibilityKey].
 */
internal data class ViewStateFrame(val key: String, val viewState: SparseArray<Parcelable>) :
  Parcelable {
  ...
  override fun writeToParcel(parcel: Parcel, flags: Int) {
    ...
    @Suppress("UNCHECKED_CAST") parcel.writeSparseArray(viewState as SparseArray<Any>)
  }
