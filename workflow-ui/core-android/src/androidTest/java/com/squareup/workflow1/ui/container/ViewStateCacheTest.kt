...
internal class ViewStateCacheTest {
  ...
  @Test fun saves_and_restores_self() {
    val rendering = NamedRendering(actual = AScreen, name = "rendering")
  ...
  @Test fun saves_and_restores_child_states_on_navigation() {
    val cache = ViewStateCache()
    val firstRendering = NamedRendering(actual = AScreen, name = "first")
    val secondRendering = NamedRendering(actual = AScreen, name = "second")
  ...
  @Test fun throws_when_view_not_bound() {
    val cache = ViewStateCache()
    val rendering = NamedRendering(actual = AScreen, name = "duplicate")
