 ...
 *
 * We wait for the Composition to finish and the Recomposer to go idle. Then advance by 200 ms as a
 * safe upper bound to allow our timeout to fire. Then wait for idle on the composition again.
 */
