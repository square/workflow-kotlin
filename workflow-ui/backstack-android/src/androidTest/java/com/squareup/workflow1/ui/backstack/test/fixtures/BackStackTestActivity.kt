...
class BackStackTestActivity : Activity() {
   ...
   */
  data class TestRendering(val name: String) : Compatible {
     ...
     */
    companion object : ViewFactory<TestRendering> by (BuilderViewFactory(TestRendering::class)
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    backstackContainer = BackStackContainer.buildView(backstack!!, viewEnvironment, this)
