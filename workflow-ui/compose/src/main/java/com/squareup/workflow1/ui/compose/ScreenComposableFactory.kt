...
public fun <ScreenT : Screen> ScreenViewFactory<ScreenT>.asComposableFactory():
  ...
  return object : ScreenComposableFactory<ScreenT> {
    ...
    @Composable override fun Content(
      ...
      val savedStateRegistry = rememberViewFactorySavedStateRegistry(
...
private class ViewFactorySavedStateRegistry(
  ...
  private val aggregator = WorkflowSavedStateRegistryAggregator().apply {
    attachToParentRegistry(parentKey, parent)
  }
