...
open class ArtifactsDumpTask @Inject constructor(projectLayout: ProjectLayout) :
  ArtifactsTask(projectLayout) {

  init {
    description =
      "Parses the Maven artifact parameters for all modules " + "and writes them to artifacts.json"
    group = "other"
  }
