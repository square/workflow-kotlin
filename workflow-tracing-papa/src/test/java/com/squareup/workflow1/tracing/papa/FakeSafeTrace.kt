...
class FakeSafeTrace(isTraceable: Boolean = true, isCurrentlyTracing: Boolean = true) :
  ...
  override fun endAsyncSection(name: String, cookie: Int) = delegate.endAsyncSection(name, cookie)
