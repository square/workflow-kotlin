...
class WorkflowPapaTracer(safeTrace: SafeTraceInterface = PapaSafeTrace(isTraceable = false)) :
...
private fun TraceInterface.asSafeTraceInterface(): SafeTraceInterface {
  return this as? SafeTraceInterface
    ?: object : SafeTraceInterface {
      override val isTraceable: Boolean
        get() = this@asSafeTraceInterface.isTraceable

      override val isCurrentlyTracing: Boolean
        get() = this@asSafeTraceInterface.isCurrentlyTracing
