...
internal fun <PropsT, OutputT, RenderingT> renderWorkflow(
  ...
  return if (COMPOSE_RUNTIME_SKIPPING in config.runtimeConfig) {
    ...
    renderWorkflowImpl(workflow, props, onOutput, config, parentSession, renderKey)
  }
}
...
private val renderWorkflowImplErased =
...
@Suppress("UNCHECKED_CAST")
private val renderWorkflowRestartableImpl =
  fun(
    workflow: Workflow<*, *, *>,
    props: Any?,
    onOutput: ((Any?) -> Unit)?,
...
@Suppress("UNCHECKED_CAST")
private val renderWorkflowRestartableImplComposable =
...
private fun restartRenderWorkflowRestartableImpl(
  ...
  renderWorkflowRestartableImpl.invoke(
    workflow,
    props,
    onOutput,
    config,
