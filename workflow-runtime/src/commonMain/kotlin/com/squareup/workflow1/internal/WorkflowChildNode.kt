 ...
 *
 * Associates the child's [StatefulWorkflowNode] (which includes the key passed to `renderChild`) with the
...
internal class WorkflowChildNode<
  ...
  /** The [StatefulWorkflowNode]'s [WorkflowNodeId]. */
  ...
  /**
   * Wrapper around [StatefulWorkflowNode.render] that allows calling it with erased types.
   */
  fun <R> render(
    workflow: Workflow<*, *, *>,
    props: Any?
