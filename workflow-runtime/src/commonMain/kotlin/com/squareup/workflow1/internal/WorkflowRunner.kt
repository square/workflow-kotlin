...
internal class WorkflowRunner<PropsT, OutputT, RenderingT>(
   ...
   *
   * This method must be called before the first call to [waitAndProcessAction], and must be called again
   * between every subsequent call to [waitAndProcessAction].
   */
  ...
  fun applyNextAvailableAction(skipDirtyNodes: Boolean = false): ActionProcessingResult {
    return rootNode.applyNextAvailableAction(skipDirtyNodes)
  }
