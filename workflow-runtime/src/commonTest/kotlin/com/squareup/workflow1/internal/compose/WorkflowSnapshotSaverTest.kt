...
internal class WorkflowSnapshotSaverTest {
  ...
  @Test
  fun save_calls_workflow_snapshotState_with_value() {
    val workflow = RecordingWorkflow()
    val saver =
      WorkflowSnapshotSaver(
        initialProps = "props",
  ...
  @Test
  fun save_returns_null_when_workflow_returns_null() {
    val workflow =
      object : StatefulWorkflow<Unit, String, Nothing, Unit>() {
  ...
  @Test
  fun restore_invokes_initialState_with_props_and_snapshot_and_scope() {
    val workflow = RecordingWorkflow()
    val scope = TestScope()
    val saver =
      WorkflowSnapshotSaver(
  ...
  @Test
  fun save_then_restore_round_trips_state() {
    val workflow = RecordingWorkflow()
    val saver =
      WorkflowSnapshotSaver(
        initialProps = "p",
