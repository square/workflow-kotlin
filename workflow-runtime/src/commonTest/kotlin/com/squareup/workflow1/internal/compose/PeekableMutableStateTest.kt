...
internal class PeekableMutableStateTest {
  ...
  @Test
  fun component1_reads_and_component2_writes() {
  ...
  @Test
  fun setWithInvalidator_invokes_invalidator_on_change() {
    val state = PeekableMutableState("init")
    var calls = 0
  ...
  @Test
  fun setWithInvalidator_skips_invalidator_when_value_equals_existing() {
  ...
  @Test
  fun setWithInvalidator_accepts_null_invalidator() {
  ...
  @Test
  fun assignment_does_not_invoke_an_invalidator() {
  ...
  @Test
  fun snapshot_isolation_writes_are_invisible_until_apply() {
    val state = PeekableMutableState("init")
  ...
  @Test
  fun snapshot_isolation_reads_inside_snapshot_see_writes_inside_snapshot() {
    val state = PeekableMutableState("init")
    val snapshot = Snapshot.takeMutableSnapshot()
    try {
      snapshot.enter {
  ...
  @Test
  fun setWithInvalidator_uses_equals_not_identity() {
