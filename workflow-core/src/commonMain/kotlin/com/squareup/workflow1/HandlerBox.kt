...
@PublishedApi
internal inline fun <P, S, O, reified E1, reified E2, reified E3> BaseRenderContext<P, S, O>
  .eventHandler3(
  name: String,
  remember: Boolean,
  key: String,
  ...
  val handler = { e1: E1, e2: E2, e3: E3 -> actionSink.send(action(name) { update(e1, e2, e3) }) }
  return if (remember) {
    val box = remember(key, typeOf<E1>(), typeOf<E2>(), typeOf<E3>()) { HandlerBox3<E1, E2, E3>() }
    box.handler = handler
    box.stableHandler
  } else {
    handler
...
@PublishedApi
internal inline fun <P, S, O, reified E1, reified E2, reified E3, reified E4> BaseRenderContext<
  P,
  S,
  O,
>
  ...
  return if (remember) {
    val box =
      remember(key, typeOf<E1>(), typeOf<E2>(), typeOf<E3>(), typeOf<E4>()) {
...
internal class HandlerBox5<E1, E2, E3, E4, E5> {
  ...
  val stableHandler: (E1, E2, E3, E4, E5) -> Unit = { e1, e2, e3, e4, e5 ->
    handler(e1, e2, e3, e4, e5)
  }
}
...
> BaseRenderContext<P, S, O>.eventHandler5(
  ...
  return if (remember) {
    val box =
      remember(key, typeOf<E1>(), typeOf<E2>(), typeOf<E3>(), typeOf<E4>(), typeOf<E5>()) {
...
internal class HandlerBox6<E1, E2, E3, E4, E5, E6> {
  ...
  val stableHandler: (E1, E2, E3, E4, E5, E6) -> Unit = { e1, e2, e3, e4, e5, e6 ->
    handler(e1, e2, e3, e4, e5, e6)
  }
}
...
internal class HandlerBox7<E1, E2, E3, E4, E5, E6, E7> {
  ...
  val stableHandler: (E1, E2, E3, E4, E5, E6, E7) -> Unit = { e1, e2, e3, e4, e5, e6, e7 ->
    handler(e1, e2, e3, e4, e5, e6, e7)
  }
}
...
internal class HandlerBox8<E1, E2, E3, E4, E5, E6, E7, E8> {
  ...
  val stableHandler: (E1, E2, E3, E4, E5, E6, E7, E8) -> Unit = { e1, e2, e3, e4, e5, e6, e7, e8 ->
    handler(e1, e2, e3, e4, e5, e6, e7, e8)
  }
}
...
internal class HandlerBox9<E1, E2, E3, E4, E5, E6, E7, E8, E9> {
  ...
  val stableHandler: (E1, E2, E3, E4, E5, E6, E7, E8, E9) -> Unit =
    { e1, e2, e3, e4, e5, e6, e7, e8, e9 ->
      handler(e1, e2, e3, e4, e5, e6, e7, e8, e9)
    }
}
...
internal class HandlerBox10<E1, E2, E3, E4, E5, E6, E7, E8, E9, E10> {
  ...
  val stableHandler: (E1, E2, E3, E4, E5, E6, E7, E8, E9, E10) -> Unit =
    { e1, e2, e3, e4, e5, e6, e7, e8, e9, e10 ->
      handler(e1, e2, e3, e4, e5, e6, e7, e8, e9, e10)
    }
}
