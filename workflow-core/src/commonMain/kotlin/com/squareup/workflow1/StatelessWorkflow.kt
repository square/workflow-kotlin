...
public abstract class StatelessWorkflow<PropsT, OutputT, out RenderingT> :
  ...
  public class RenderContext<PropsT, OutputT>
  internal constructor(baseContext: BaseRenderContext<PropsT, *, OutputT>) :
    BaseRenderContext<PropsT, Nothing, OutputT> by baseContext
      as BaseRenderContext<PropsT, Nothing, OutputT> {
    @PublishedApi
    ...
    /**
     * Given an [update] function, wraps it in a lambda suitable for use as an event handler on a
     * rendered view model. See [StatefulWorkflow.RenderContext.eventHandler] for details.
     *
    ...
    > eventHandler(
      ...
      remember: Boolean? = null,
      key: String = name,
      noinline update: Updater<PropsT, *, OutputT>.(E1, E2, E3, E4, E5, E6) -> Unit,
    ...
    > eventHandler(
      ...
      remember: Boolean? = null,
      key: String = name,
      noinline update: Updater<PropsT, *, OutputT>.(E1, E2, E3, E4, E5, E6, E7) -> Unit,
    ...
    > eventHandler(
      ...
      remember: Boolean? = null,
      key: String = name,
      noinline update: Updater<PropsT, *, OutputT>.(E1, E2, E3, E4, E5, E6, E7, E8) -> Unit,
    ...
    > eventHandler(
      ...
      remember: Boolean? = null,
      key: String = name,
      noinline update: Updater<PropsT, *, OutputT>.(E1, E2, E3, E4, E5, E6, E7, E8, E9) -> Unit,
    ...
    > eventHandler(
      ...
      remember: Boolean? = null,
      key: String = name,
      noinline update: Updater<PropsT, *, OutputT>.(E1, E2, E3, E4, E5, E6, E7, E8, E9, E10) -> Unit,
    ): (E1, E2, E3, E4, E5, E6, E7, E8, E9, E10) -> Unit =
      eventHandler10(name, remember ?: stableEventHandlers, key, update)
  }

  /** Class type returned by [asStatefulWorkflow]. See [statefulWorkflow] for the instance. */
  private inner class StatelessAsStatefulWorkflow :
    StatefulWorkflow<PropsT, Unit, OutputT, RenderingT>() {

    override fun initialState(props: PropsT, snapshot: Snapshot?) = Unit
 ...
 * [props][PropsT] received from its parent, and it may render child workflows that do have their
 * own internal state.
 */
public inline fun <PropsT, OutputT, RenderingT> Workflow.Companion.stateless(
  ...
  object : StatelessWorkflow<PropsT, OutputT, RenderingT>() {
    override fun render(renderProps: PropsT, context: RenderContext<PropsT, OutputT>): RenderingT =
 ...
 */
public fun <PropsT, OutputT, RenderingT> StatelessWorkflow<PropsT, OutputT, RenderingT>.action(
  name: String,
  update: Updater<PropsT, *, OutputT>.() -> Unit,
...
public fun <PropsT, OutputT, RenderingT> StatelessWorkflow<PropsT, OutputT, RenderingT>.action(
  name: () -> String,
  update: Updater<PropsT, *, OutputT>.() -> Unit,
): WorkflowAction<PropsT, Nothing, OutputT> =
  object : WorkflowAction<PropsT, Nothing, OutputT>() {
