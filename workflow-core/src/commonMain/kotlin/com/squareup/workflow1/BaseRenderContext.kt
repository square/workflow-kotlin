...
BaseRenderContext<PropsT, StateT, OutputT>.ChildRendering(
  ...
  hoistRendering: @Composable (ChildRenderingT) -> Unit,
  handler: (ChildOutputT) -> WorkflowAction<PropsT, StateT, OutputT>
): Unit = ChildRendering(child, Unit, key, hoistRendering, handler)
/**
...
BaseRenderContext<PropsT, StateT, OutputT>.ChildRendering(
  ...
  key: String = "",
  hoistRendering: @Composable (ChildRenderingT) -> Unit,
): Unit = ChildRendering(child, props, key, hoistRendering) { noAction() }
/**
...
BaseRenderContext<PropsT, StateT, OutputT>.ChildRendering(
  ...
  key: String = "",
  hoistRendering: @Composable (ChildRenderingT) -> Unit,
): Unit = ChildRendering(child, Unit, key, hoistRendering) { noAction() }
